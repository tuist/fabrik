...
impl DaemonState {
    ...
    pub fn save(&self) -> Result<()> {
        ...
        // Save PID
        fs::write(self.pid_file(), self.pid.to_string())
    ...
    pub fn generate_env_exports(&self, shell: &str) -> String {
        ...
        match shell {
            "fish" => {
                ...
                exports.push(format!("set -gx NX_SELF_HOSTED_REMOTE_CACHE_SERVER {}", http_url));
            ...
            _ => {
                ...
                exports.push(format!("export NX_SELF_HOSTED_REMOTE_CACHE_SERVER={}", http_url));
